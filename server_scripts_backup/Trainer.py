...
class Trainer:
    ...
    def train(self, train_loaders, test_loaders, save_interm = True, prev_fisher = None, prev_params = None) -> dict:
        """
        ...
        if True:
            for epoch in range(self.num_epochs):
                ...
                epoch_train_loss, epoch_train_acc, fisher_diag = \
                    self.train_epoch(train_loader, epoch, compute_new_fisher = False, prev_fisher = prev_fisher, prev_params = prev_params)
