...
basepath="/content/drive/MyDrive/robust-features-for-cl"

def obtain_metrics(path:str, no_tasks = 6, big_dataset = True):
  all_metrics = {}
...
all_metrics = obtain_metrics(basepath+'/'+model_type, no_tasks = 6)

plot_all_metrics_for_model(all_metrics = all_metrics, model_type = model_type, save_to = "plots_"+model_type+".pdf")

def plot_accuracies_for_model(all_metrics, model_type, no_tasks = None, save_to = None):
  if save_to == None:
    save_to = "acc_plots"+model_type+".pdf"
  if no_tasks == None:
    len(all_metrics.keys())
  """
